...
contract('FmhTokenSale', function(accounts) {
	...
	it('initializes the contract with the correct values', function() {
		return FmhTokenSale.deployed().then(function(instance) {
	...
	it('facilitates token buying', function() {
		return FmhToken.deployed().then(function(instance) {
			...
			assert.equal(balance.toNumber(), numberOfTokens, 'adds the number of tokens to the buyer balance');
			return tokenInstance.balanceOf(tokenSaleInstance.address);
		}).then(function(balance) {
			assert.equal(balance.toNumber(), tokensAvailable-numberOfTokens, 'deducts the tokens sold from the tokens available');
